# CodeQL Setup for deepiri-zepgpu
...
- `.github/codeql/codeql-config.yml`
  - Defines what folders to include and ignore during analysis, tailored to this monorepo's structure.
...
paths-ignore:
  ...
  - '**/logs/**'
  - '**/*.min.js'
  - 'zepgpu-ui/node_modules/**'
  - 'zepgpu-ui/dist/**'
  - 'zepgpu-ui/build/**'
  - 'zepgpu-ui/coverage/**'
  - 'zepgpu-ui/*.min.js'
  - 'deepiri_zepgpu/resources/datasets/**'
  - 'deepiri_zepgpu/resources/models/**'
  - 'deepiri_zepgpu/resources/kernel_cache/**'
  - 'deepiri_zepgpu/storage/result_store.py'
  - 'deepiri_zepgpu/storage/s3_client.py'
```
