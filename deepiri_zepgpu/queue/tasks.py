...
from deepiri_zepgpu.database.models.task import Task as DBTask
...
def execute_task(  # noqa: C901
    ...
    async def _execute() -> dict[str, Any]:  # noqa: C901
        async with get_db_context() as db:
            repo = TaskRepository(db)
            ...
            if task.dispatch_mode in {"room_auto", "room_specific_node"}:
