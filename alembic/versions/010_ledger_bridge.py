...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_ledger_bridge_receipts_receipt_id", "ledger_bridge_receipts", ["receipt_id"]
    )
    op.create_index(
        "ix_ledger_bridge_receipts_source_chain_id", "ledger_bridge_receipts", ["source_chain_id"]
    )
    op.create_index(
        "ix_ledger_bridge_receipts_dest_chain_id", "ledger_bridge_receipts", ["dest_chain_id"]
    )
