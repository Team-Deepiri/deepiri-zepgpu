...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_scheduled_tasks_user_enabled", "scheduled_tasks", ["user_id", "is_enabled"]
    )
    op.create_index(
        "idx_scheduled_tasks_next_run_enabled", "scheduled_tasks", ["next_run_at", "is_enabled"]
    )
    ...
    op.create_index(
        "idx_scheduled_task_runs_schedule_created",
        "scheduled_task_runs",
